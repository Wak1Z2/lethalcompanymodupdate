...
- Fixed compatibility with MoreCompany v1.11.0 (Credit to [1A3](https://github.com/1A3Dev) for the [report and solution](https://github.com/quackandcheese/MirrorDecor/pull/2))
...
- Fixed chat message error when MoreCompany is not installed (Credit to [legoandmars](https://github.com/legoandmars/) for the report and solution)
