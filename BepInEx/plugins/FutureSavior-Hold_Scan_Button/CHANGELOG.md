- **1.1.2**
    - Mod has been undeprecated is now up to date again.

- **1.1.1**
    - Uploaded a higher quality version of the icon.

- **1.1.0**
    - Fixed the compatibility issues. BIG Credit to NikolaTeslaX for figuring out this solution, I can't thank you enough.
