...
| ----------- | ----------- | ----------- | ----------- |
| `MessageDuration` | `Single` | `4` | The message duration in seconds. |
| `MessageFontSize` | `Single` | `35` | The message font size in pixels. |
...
## Screenshots
<img src="https://i.imgur.com/Cg0sto9.png" width="100%">